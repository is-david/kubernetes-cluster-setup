...
* connect the rest of the control planes as per command in 5_rest.sh script and values from kubeadm init performed on control1 earlier
* connect worker nodes as per command in 5_rest.sh script and values from kubeadm init performed on control1 earlier
